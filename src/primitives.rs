...
#[doc = concat!("[`String`]: ", "string::String")]
/// [`FromStr`]: str::FromStr
///
/// # `!` and traits
///
...
#[doc = concat!("[`into_raw`]: ", "Box::into_raw")]
/// [`drop`]: mem::drop
/// [`write`]: ptr::write
#[stable(feature = "rust1", since = "1.0.0")]
mod prim_pointer {}
...
/// [`std::fmt`]: fmt
/// [`Hash`]: hash::Hash
#[doc = concat!("[`ToSocketAddrs`]: ", "net::ToSocketAddrs")]
///
...
#[doc = concat!("[`Seek`]: ", "io::Seek")]
#[doc = concat!("[`BufRead`]: ", "io::BufRead")]
#[doc = concat!("[`Read`]: ", "io::Read")]
#[doc = concat!("[`io::Write`]: ", "")]
///
